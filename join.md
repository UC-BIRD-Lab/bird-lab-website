...
<p class="muted" style="font-size:var(--step--1)"><strong>Grad-school timing:</strong> UC&nbsp;Davis admits once a year, with <a href="https://grad.ucdavis.edu/program-application-deadlines">priority deadlines in December</a>. I start interviewing in early fall — reach out then to be considered for the lab specifically.</p>

<p class="muted" style="font-size:var(--step--1)"><strong>Funding your own spot?</strong> Browse our <a href="{{ '/lab-guide/apply-for-money/' | relative_url }}">curated list of fellowships &amp; scholarships</a> — options for undergraduates, graduate students, and postdocs.</p>
...
<p class="muted" style="font-size:var(--step--1)">First time reaching out to a research lab? Two guides I like:
