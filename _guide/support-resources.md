...
- [Center for Advocacy, Resources & Education (CARE) confidential advocate](https://care.ucdavis.edu/connect-advocate): all UC Davis affiliates, including postdocs. Sexual assault, dating violence, stalking.
- [Student Health and Counseling Services (SHCS) crisis care & urgent help](https://shcs.ucdavis.edu/crisis-care-and-urgent-help-resources): registered students (undergraduate and graduate). Mental-health crisis counseling.
- [Aggie Mental Health](https://mentalhealth.ucdavis.edu/i-need-help): students. Full list of crisis and support lines.
</div>

<div class="callout callout--warn" markdown="1">
Dr. Harvey is a [Responsible Employee](https://hdapp.ucdavis.edu/responsible-employee).
She must report potential violations of University policy related to sexual
harassment, sexual violence, discrimination, or harassment that are brought to
her attention. If you need a **confidential** resource, several are listed below. Please verify their confidentiality yourself, before sharing.
</div>
...
- [Harassment & Discrimination Assistance and Prevention Program (HDAPP)](https://hdapp.ucdavis.edu/)
- [EthicsPoint (University of California)](https://secure.ethicspoint.com/domain/media/en/gui/23531/index.html): report ethical concerns (anonymous option)
- [UC Systemwide Campus Climate](https://ucsystems.ethicspointvp.com/custom/ucs_ccc/default.asp): report discriminatory situations (anonymous option)

## More lists of resources

- [Additional resources (WRRC)](https://wrrc.ucdavis.edu/resources/additional)
- [Report hate & bias: confidential resources](https://reporthateandbias.ucdavis.edu/confidential-resources)
- [Get support: sexual violence & harassment](https://sexualviolence.ucdavis.edu/get-support)

Know a resource that should be on this page? [Tell Christina]({{ '/contact/' | relative_url }}) and we'll add it.
