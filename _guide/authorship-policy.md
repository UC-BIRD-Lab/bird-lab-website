...
Authorship is how credit and accountability are shared on everything the lab
publishes. We agree it openly, we write it down, and we revisit it as
contributions change.

## Roles

<aside class="marginnote" markdown="1">
**If you are the first author, act like it.** Don't accept an edit you disagree
with just because it came from a senior author. Push back or ask for the reasoning.
Reviewers, including Christina, are not always right, and the paper is yours to
defend.
</aside>
